function selectedItem(mainItem,others){
...
if(others!=null){
    others.forEach(function (k) {
        console.log(k)
        console.log(nodes_raw.filter(function (d) { return d.name == k; }))
       // drawDottedHoverCircle(nodes_raw.filter(function (d) { return d.name ==k; })[0])
